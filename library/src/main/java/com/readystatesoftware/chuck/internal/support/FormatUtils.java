...
public class FormatUtils {
    ...
    public static String formatXml(String xml) {
        try {
            ...
            Source xmlSource =
                new SAXSource(new InputSource(new ByteArrayInputStream(xml.getBytes())));
    ...
    public static String getShareText(Context context, HttpTransaction transaction) {
        ...
        text +=
            context.getString(R.string.chuck_protocol) + ": " + v(transaction.getProtocol()) + "\n";
        text += context.getString(R.string.chuck_status)
            + ": "
            + v(transaction.getStatus().toString())
            + "\n";
        text += context.getString(R.string.chuck_response) + ": " + v(
            transaction.getResponseSummaryText()) + "\n";
        text += context.getString(R.string.chuck_ssl) + ": " + v(
            context.getString(transaction.isSsl() ? R.string.chuck_yes : R.string.chuck_no)) + "\n";
        text += "\n";
        text += context.getString(R.string.chuck_request_time) + ": " + v(
            transaction.getRequestDateString()) + "\n";
        text += context.getString(R.string.chuck_response_time) + ": " + v(
            transaction.getResponseDateString()) + "\n";
        text += context.getString(R.string.chuck_duration)
            + ": "
            + v(transaction.getDurationString())
            + "\n";
        text += "\n";
        text += context.getString(R.string.chuck_request_size) + ": " + v(
            transaction.getRequestSizeString()) + "\n";
        text += context.getString(R.string.chuck_response_size) + ": " + v(
            transaction.getResponseSizeString()) + "\n";
        text += context.getString(R.string.chuck_total_size) + ": " + v(
            transaction.getTotalSizeString()) + "\n";
        text += "\n";
        ...
        text +=
            (transaction.responseBodyIsPlainText()) ? v(transaction.getFormattedResponseBody()) :
                context.getString(R.string.chuck_body_omitted);
        return text;
    }
